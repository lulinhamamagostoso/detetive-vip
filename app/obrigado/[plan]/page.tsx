      ...
      <div className="min-h-screen py-8 px-4" style={{ background: "var(--background)" }}>
        <div className="max-w-md mx-auto text-center">
          ...
          <p className="text-sm mb-6" style={{ color: "var(--muted-foreground)" }}>
            Seu relatório chega no WhatsApp em até 5 minutos — você não precisa fazer mais nada. Se quiser, pode mandar uma mensagem pra acompanhar o andamento:
          </p>
          <a
    ...
    <div className="min-h-screen" style={{ background: "var(--background)" }}>
      ...
      <div className="max-w-lg mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm font-medium mb-2" style={{ color: "var(--whatsapp)" }}>
            R${config.planPrice},00 — {config.planName}
          </p>
          <p className="text-[0.85rem] mb-1" style={{ color: "var(--foreground)" }}>
            Um de nossos investigadores já recebeu seu pedido.
          </p>
          <p className="text-[0.8rem]" style={{ color: "var(--muted-foreground)" }}>
            Você receberá o relatório no WhatsApp em até 5 minutos — não precisa fazer mais nada.
          </p>
        </div>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl font-bold text-white text-sm uppercase tracking-wide mb-2"
        ...
        <p className="text-center text-[0.68rem] mb-8" style={{ color: "var(--muted)" }}>
